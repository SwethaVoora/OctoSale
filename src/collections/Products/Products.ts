...
export const Products: CollectionConfig = {
  ...
  fields: [
    {
      name: "user", //each product should be associated with a user...as they are the ones adding their products
      type: "relationship",
      relationTo: "users",
      required: true,
      hasMany: false, //one product cant be created by multiple people
      admin: {
        condition: () => false,
      },
    },
